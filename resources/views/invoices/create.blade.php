                    ...
                    <form action="{{ route('invoices.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputName" value="{{old('number')}}" name="number"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control fc-datepicker" value="{{old('due_date')}}" name="due_date"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="product_id" class="form-control" id="product">
                                        ...
                                        @if(old('product_id') || old('section_id'))
                                            @foreach(product(old('section_id')) as $value)
                                                <option
                                                    value="{{$value->id}}" {{ (old('product_id') == $value->id ? 'selected':'') }}>{{ $value->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('product_id')
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{old('amount_collection')}}" max="" id="inputName"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="{{old('amount_commission')}}"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{old('discount')}}" class="form-control form-control-lg" id="discount"
                                           name="discount"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="rate_vat" id="rate_vat" class="form-control" onchange="myFunction()">
                                        <!--placeholder-->
                                        <option selected disabled>حدد نسبة الضريبة</option>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{old('value_vat')}}" class="form-control" id="value_vat" name="value_vat"
                                           readonly>
                                    @error('value_vat')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                        ...
                        <div class="form-group mb-3">
                            <div class="col-lg-12">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note">{{old('note')}}</textarea>
                            </div>
                            @error('note')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
