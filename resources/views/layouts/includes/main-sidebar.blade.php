...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidemenu">
        <h3 class="text-black text-center mb-5 ">Invoice</h3>
        ...
        <ul class="side-menu mx-3">
            ...
            @can('invoices')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('invoices.index') }}">قوائم الفواتير</a></li>
                        <li><a class="slide-item" href="{{ route('invoices.paid') }}">القوائم المدفوعة</a></li>
                        <li><a class="slide-item" href="{{ route('invoices.unpaid') }}">القوائم الغير مدفوعة</a></li>
                        <li><a class="slide-item" href="{{ route('invoices.partial') }}">القوائم المدفوعة جزئيآ</a></li>
                        <li><a class="slide-item" href="{{ route('invoices.archive') }}">القوائم المؤرشفة</a></li>
            ...
            @can('reports')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('reports.index') }}">قوائم الفواتير</a></li>
                    </ul>
                </li>
            @endcan
            @can('roles')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('roles.index') }}"> التحكم بالصلاحيات</a></li>
                    </ul>
                </li>
            @endcan
            @can('users')
                <li class="side-item side-item-category">المستخدمسن</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                        ...
                        <span class="side-menu__label">المستخدمسن</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
            ...
            @can('settings')
                ...
                <li class="slide" style="margin-bottom: 100px !important;">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
